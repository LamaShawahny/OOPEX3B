...
Now we have the ability to log in with our ID number,
we have added moves and score limitations according to the table we have recieved.
now we start from level 0 , to get to the next level you have to pass the score with the least moves possible acoording to the current level and so on.


the Project allows you to choose between 24 different graph options , each graph has different number of iron man duplicates and villians ,Now we have the ability to log in with our ID number,
we have added moves and score limitations according to the table we have recieved.
now we start from level 0 , to get to the next level you have to pass the score with the least moves possible acoording to the current level and so on. , You can choose to play in two different modes:  
